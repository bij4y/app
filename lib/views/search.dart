              ...
              child: Obx(
                () => ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      print(controller.foundPlayers[index]);
                      return InkWell(
                        onTap: () {
                          // controller.fetchData(controller
                          //           .foundPlayers[index].id);
                          //       Get.to(() => const TailorDetails());
                        },
                        child: ListTile(
                          leading: Image.network(ApiUrl().url +
                              controller.foundPlayers[index].feature),
                          title: Text(
                            controller.foundPlayers[index],
                            style: TextStyle(
                          ...
                          subtitle: Row(
                            children: [
                              Icon(Icons.place),
                              Text(controller.foundPlayers[index].address),
                            ],
                          ),
                        ),
                      );
